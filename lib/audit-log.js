...
export const AUDIT_ACTIONS = {
  LOGIN: {
    label: "ورود به سیستم",
    tone: "success",
    sentence: (actor, d, role) => `${actor} (${roleLabel(role)}) وارد سیستم شد`,
  },
  LOGOUT: {
    label: "خروج از سیستم",
    tone: "neutral",
  ...
  PASSWORD_RESET_REQUESTED: {
    ...
    sentence: (actor, d) =>
      d.found === false
        ? `درخواست بازیابی رمز عبور برای نام کاربری ناموجود «${d.username || "نامشخص"}» ثبت شد`
  ...
  CREATE_GRADE: {
    label: "ثبت نمره",
    tone: "info",
    sentence: (actor, d) => `${actor} نمره‌ای برای «${targetName(d)}» ثبت کرد`,
  },
  CREATE_TEST: {
    label: "ایجاد آزمون",
    tone: "info",
